  ...
  return (
    <div className="min-h-screen bg-slate-950 font-sans text-slate-200 overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-10 w-72 h-72 bg-teal-500 rounded-full mix-blend-screen filter blur-[100px] opacity-20 animate-blob"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/2 w-72 h-72 bg-blue-500 rounded-full mix-blend-screen filter blur-[100px] opacity-10 animate-blob"
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3 group cursor-pointer">
              <div className="relative">
                ...
                <Compass
                  size={36}
                  className="relative text-white transform group-hover:rotate-12 transition-transform"
                />
              </div>
            ...
            >
              <button className="group relative px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-slate-950 rounded-xl font-bold">
                Get Started
              </button>
            </SignInButton>
          </div>
      ...
      <main className="relative max-w-7xl mx-auto pt-40 px-6">
        <div className="text-center z-10 relative">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed">
            The abundance of online courses is overwhelming. We use AI to build
            a structured, personalized learning roadmap from zero to mastery.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-24">
            <SignInButton mode="modal">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-slate-950 rounded-xl text-lg font-bold transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(16,185,129,0.3)]">
                <span className="relative z-10 flex items-center gap-2">
                  ...
                  <Zap
                    size={18}
                    className="text-slate-900 group-hover:animate-pulse"
                  />
                </span>
              </button>
            </SignInButton>
            ...
            <button className="px-8 py-4 bg-slate-900 text-slate-200 rounded-xl text-lg font-semibold border border-slate-700 hover:border-emerald-500/50 hover:bg-slate-800 transition-all duration-300 flex items-center gap-2 group">
              ...
              <ChevronRight
                size={18}
                className="group-hover:translate-x-1 text-emerald-400 transition-transform"
              />
            </button>
          </div>
        ...
        <div className="relative mb-32">
          ...
          <div className="relative bg-slate-900 border border-slate-800 rounded-3xl p-16 text-center shadow-2xl">
            ...
            <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of learners who have already found their perfect
              learning path with AI.
            </p>
            <SignInButton mode="modal">
  ...
  return (
    <div className="group relative">
      ...
      <div className="relative p-8 bg-slate-900 rounded-2xl border border-slate-800 hover:border-emerald-500/50 transition-all duration-300 h-full">
        <div className="mb-6 p-3 bg-slate-950 rounded-lg inline-block border border-slate-800 group-hover:border-emerald-500/30">
          {icon}
        </div>
